...
export async function GET(
  ...
  const [bookResult, authorsResult, artistsResult, exhibitionsResult] = await Promise.all([
  ...
  const error = bookResult.error ?? authorsResult.error ?? artistsResult.error ?? exhibitionsResult.error
